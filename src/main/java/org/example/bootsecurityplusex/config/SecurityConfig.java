package org.example.bootsecurityplusex.config;

import org.example.bootsecurityplusex.service.CustomUserDetailsService;
...
//                .logout(Customizer.withDefaults()); // 기본을 쓰자
                .logout(logout -> logout.permitAll()).userDetailsService(customUserDetailsService); // 기본을 쓰자
        return http.build();
    }
    @Bean
